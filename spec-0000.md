...
In semantic versioning, version numbers are `MAJOR.MINOR.PATCH`.
The recommendations here pertain to the initial release date of minor releases (i.e., Python 3.8.0 is from 14 October 2019, NumPy 1.19.0 is from 20 June 2020, etc).

Specifically, we recommend that:

1. Support for a minor version of Python be dropped **3 years** after its initial release.
2. Support for a minor version of other core packages be dropped **2 years** after their initial release.
